...
## This scores the women's half of the meet. Let's go Ladies!
use strict;
use DBI;
use Data::Dumper;
use Switch;
...
my $events = $dbh->selectall_hashref("SELECT * FROM events WHERE gender='w'", 1);;
...
#print "Adding $currentpoints to school $currentschool->{'name'}\n";
    }
  }
}
